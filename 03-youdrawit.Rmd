...
```{r eyefitting-example-plot, fig.cap = "Eye Fitting Straight Lines in the Modern Era Example", out.width="25%"}
...
trial.feedback %>%
  ...
  geom_line(aes(y = yloess, color = "Drawn (loess)", linetype = "Drawn (loess)")) +
...
```{r eyefitting-gammpred-plots, fig.cap = "Eye Fitting Straight Lines in the Modern Era GAMM", out.width="50%"}
...
```{r eyefitting-lmer-preds, fig.cap = "Eye Fitting Straight Lines in the Modern Era LMER", out.width="50%"}
