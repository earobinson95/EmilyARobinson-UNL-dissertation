...
In @finney_subjective_1951, researchers were interested in assessing the effect of stopping iterative maximum likelihood calculations after one iteration. 
...
```{r eyefitting-simplot, echo=F, fig.cap="Eye Fitting Straight Lines in the Modern Era Simulated Data Example", fig.height=8, fig.width=8, message=FALSE, warning=FALSE, out.width="100%"}
