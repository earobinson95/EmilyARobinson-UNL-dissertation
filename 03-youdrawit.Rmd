...
```{r ols-vs-pca-example, fig.height = 6, fig.width = 8, fig.cap="OLS vs PCA Regression Lines", message=FALSE, warning=FALSE, out.width="90%"}
library(ggplot2)
library(magrittr)
library(plyr)
...
```{r eyefitting-lmer-residualplots, fig.height = 8, fig.width = 12, out.width = "90%", fig.cap = "Eye Fitting Straight Lines in the Modern Era LMM results"}
...
```{r eyefitting-gamm-residualplots, fig.height = 8, fig.width = 12, out.width = "90%", fig.cap = "Eye Fitting Straight Lines in the Modern Era GAMM results"}
...
```{r exponential-yloess-spaghetti-plot, fig.height = 8, fig.width = 12, out.width = "90%", fig.cap = "Exponential Prediction Spaghetti Plot"}
...
```{r exponential-prediction-gamm-preds, fig.height = 8, fig.width = 12, out.width = "90%", fig.cap = "Exponential Prediction GAMM Results"}
