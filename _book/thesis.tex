...
In this section I outline the data simulation process conducted in R, constructing interactive plots with D3.js code and R shiny, and the experiment design used to collect participant responses.
...
{\centering \includegraphics[width=0.25\linewidth,]{thesis_files/figure-latex/eyefitting-example-plot-1} 
...
{\centering \includegraphics[width=0.5\linewidth,]{thesis_files/figure-latex/eyefitting-gammpred-plots-1} 

}

\caption{Eye Fitting Straight Lines in the Modern Era GAMM}\label{fig:eyefitting-gammpred-plots}
\end{figure}

\begin{figure}[tbp]

{\centering \includegraphics[width=0.5\linewidth,]{thesis_files/figure-latex/eyefitting-lmer-preds-1} 

}

\caption{Eye Fitting Straight Lines in the Modern Era LMER}\label{fig:eyefitting-lmer-preds}
\end{figure}
