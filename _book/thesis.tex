...
{\centering \includegraphics[width=0.75\linewidth,]{images/amer-poggendorff-illusion} 
...
{\centering \includegraphics[width=0.75\linewidth,]{images/framed-murder-rate-map} 
...
Supported by the grammar of graphics, a data plots can be characterized as a statistic defined as, ``a functional mapping of a variable or set of variables'' (Vanderplas, Cook, \& Hofmann, 2020).
