...
For example, 1536 was a common population estimate for year 20 because visually the location of estimation lands about halfway between grid lines 1024 and 2048 \pcref{fig:qi1-sketch; fig:qi2-sketch}. 
...
```{r fig.height = 9, fig.width=9, message=FALSE, warning=FALSE, common-population-estimates, fig.cap="Estimated Population: Common responses", out.width="100%"}
...
```{r qe2-sketch, eval = T, fig.height = 9, fig.width = 9, out.width = "100%", fig.cap = "Elementary Q2 Sketch"}
...
```{r, density-grid-example, eval = F, fig.cap = "Density Grid Example", fig.width = 9, fig.height = 9, out.width = "100%", message=FALSE, warning=FALSE}

# DATA SET 1
qe2_density_1a <- densityPlot(data = qe2_data, datasetID = "dataset1", "response", xlabel = "Estimated Year", x_limits = c(0,50), zoom = T, scalesx = F, zoom_limits = c(20,33), gridlines = F, rugjitter = 0.25) +
  ggtitle("Data set 1")

qe2_density_1b <- densityPlot(data = qe2_data, datasetID = "dataset1", "response", xlabel = "Estimated Year", x_limits = c(0,50), zoom = T, scalesx = T, zoom_limits = c(20,33), gridlines = F, rugjitter = 0.25) +
  ggtitle("Data set 1")

qe2_density_1a <- ggplot_build(qe2_density_1a)
qe2_density_1b <- ggplot_build(qe2_density_1b)

# re-set zoomed facet's limits to match zoomed range
k <- qe2_density_1b$layout$layout$SCALE_X[qe2_density_1b$layout$layout$name == "x"]
qe2_density_1b$layout$panel_scales_x[[k]]$limits <- qe2_density_1b$layout$panel_scales_x[[k]]$range$range 

# re-set zoomed facet's panel parameters based on original version p0
k <- qe2_density_1b$layout$layout$PANEL[qe2_density_1b$layout$layout$name == "x"]
qe2_density_1b$layout$panel_params[[k]] <- qe2_density_1a$layout$panel_params[[k]]

# convert built ggplot object to gtable of grobs as usual & print result
qe2_density_1b <- ggplot_gtable(qe2_density_1b)


# DATA SET 2
qe2_density_2a <- densityPlot(data = qe2_data, datasetID = "dataset2", "response", xlabel = "Estimated Year", x_limits = c(0,50), zoom = T, scalesx = F, zoom_limits = c(20,33), gridlines = F, rugjitter = 0.25) +
  ggtitle("Data set 2")

qe2_density_2b <- densityPlot(data = qe2_data, datasetID = "dataset2", "response", xlabel = "Estimated Year", x_limits = c(0,50), zoom = T, scalesx = T, zoom_limits = c(20,33), gridlines = F, rugjitter = 0.25) +
  ggtitle("Data set 2")

qe2_density_2a <- ggplot_build(qe2_density_2a)
qe2_density_2b <- ggplot_build(qe2_density_2b)

# re-set zoomed facet's limits to match zoomed range
k <- qe2_density_2b$layout$layout$SCALE_X[qe2_density_2b$layout$layout$name == "x"]
qe2_density_2b$layout$panel_scales_x[[k]]$limits <- qe2_density_2b$layout$panel_scales_x[[k]]$range$range 

# re-set zoomed facet's panel parameters based on original version p0
k <- qe2_density_2b$layout$layout$PANEL[qe2_density_2b$layout$layout$name == "x"]
qe2_density_2b$layout$panel_params[[k]] <- qe2_density_2a$layout$panel_params[[k]]

# convert built ggplot object to gtable of grobs as usual & print result
qe2_density_2b <- ggplot_gtable(qe2_density_2b)

# PLOT BOTH
grid::grid.draw(qe2_density_1b)
grid::grid.draw(qe2_density_2b)
```
...
```{r qi1-density-1, fig.cap = "Intermediate Q1 Density (Data set 1)", fig.width = 9, fig.height = 9, out.width = "100%", message=FALSE, warning=FALSE}
...
```{r qi1-density-2, fig.cap = "Intermediate Q1 Density (Data set 2)", fig.width = 9, fig.height = 9, out.width = "100%", message=FALSE, warning=FALSE}
...
<!-- Correct logic: Log scale-->

<!-- Sample 1 estimated between grid lines but anchoed to grid lines-->
<!-- Calculations -->
<!-- 2048 - 1024=1024 -->
<!-- 1024 - 512=512 -->
<!-- 1024 + 512=1536 -->
...
<!-- Correct logic: Linear scale -->
<!-- Sample 1 - anchored to base ten -->
<!-- 15000 - 2500=12500	 -->
<!-- In 20 ABY the population of Ewoks was 2500, in 40 ABY the population was 15 000, i would make a substraction -->

<!-- Sample 2 -->
<!-- 1000-24000=-23000 -->
<!-- In the 4520 the tribbles population was almost 1000, in 4540 it increases in 24000. -->

<!-- Incorrect logic: Log scale-->
...
<!-- Sample 3 -->
<!-- 81cb45ebdd654b7003743767d684a6da -->
...
<!-- Could be due to order in which participant was shown the questions (e.g. QI2 before QI1?) -->

```{r, qi1-common-responses, fig.cap = "Intermediate Q1 Common Responses", fig.width = 9, fig.height = 9, out.width = "100%", message=FALSE, warning=FALSE}
