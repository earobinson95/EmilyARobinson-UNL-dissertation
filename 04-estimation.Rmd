...
In addition to estimating the population from a given year, participants were asked, \textit{"In what year does the population reach 4,000?"} \pcref{fig:qe2-sketch}.
...
```{r qe2-sketch, eval = T, fig.height = 9, fig.width = 9, out.width = "100%", fig.scap = "Elementary Q2 sketch", fig.cap = "Sketch of the estimation procedure asked in Elementary Q2. Participants first locate 4000 along the $y$-axis and move to the right until they beleive they have found the correct location on the curve; then participants look down to the $x$-axis for their estimated year."}
