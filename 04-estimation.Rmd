...
```{r, qi2-plots, fig.cap = "Intermediate Q2 Observed Plot", fig.width = 9, fig.height = 9, out.width = "100%", message=FALSE, warning=FALSE}
qi2_plot_1 <- qi2_data %>%
    filter(dataset == "dataset1") %>%
...
```{r qi2-density, fig.cap = "Intermediate Q2 Density", fig.width = 9, fig.height = 9, out.width = "100%", message=FALSE, warning=FALSE}
...
```{r, qi2-common-responses, fig.cap = "Intermediate Q2 Common Responses", fig.width = 9, fig.height = 9, out.width = "100%", message=FALSE, warning=FALSE}
...
```{r qi3-density, fig.cap = "Intermediate Q3 Density", fig.width = 9, fig.height = 9, out.width = "100%", message=FALSE, warning=FALSE}
