...
Misleading charts might have (1) bad form such as 3D pie charts or an incompatiable plot for the data \pcref{fig:misleading-graphics-form} [@reddit_dataisugly; @lowndes2017our], (2) include too much "chartjunk", resulting in clutter or displaying useless data \pcref{fig:misleading-graphics-chartjunk} [@graphcrimes_2022; @wikipedia_x86_64], or (3) have bad axes such as a mismatch between scale and context or just plain bad math \pcref{fig:misleading-graphics-bad-axes} [@villa_2022; @lauren_2018].
...
Many efforts have been made to provide guidelines for graphical designs including Wilkinson's Grammar of Graphics [@wilkinson2013grammar].
...
We have recently experienced the benefits and pitfalls of using log scales as COVID-19 dashboards displayed case count data on both the log and linear scale [@fagen-ulmschneider_2020; @burnmurdoch_2020]. 
