...
```{r log-number-line, fig.cap= "Kindergarten example of mapping numbers 1-10 along a number line", fig.height=1, fig.width=4.5, message=FALSE, warning=FALSE}
...
```{r menge-plots, fig.cap = "Graphs viewed in Menge (2018) survey", out.width="75%"}
