...
Instead, we are simply testing the change in perceptual sensitivity resulting from visualization choices. In @best_perception_2007, the authors explored whether discrimination between curve types is possible.
...
Recent graphical experiments have utilized statistical lineups to quantify the perception of graphical design choices[@vanderplas_clusters_2017, @hofmann_graphical_2012, @loyVariationsQQPlots2016]. 
Statistical lineups provide an elegant way of combining perception and statistical hypothesis testing using graphical experiments [@wickham2010graphical, @majumder_validation_2013, @vanderplas_statistical_nodate].
...
In this paper, we use statistical lineups to test our ability to differentiate between exponentially increasing curves with differing levels of curvature, using linear and log scales. @vanderplas_statistical_nodate provides an approach for calculating visual p-values utilizing a 'rorschach' lineup which consists soley of null panels.