...
<!-- \svp{I would honestly lead with this part...} -->

```{r graphic-flowchart, include = F, fig.cap = "Graphic flowchart", out.width="50%"}
...
In \cref{fig:william-playfair-trade}, @playfair1801statistical visually represent the power and economic status of each European Nation in the early $\text{19}^{\text{th}}$ century. 
...
\cref{fig:statistical-atlas-state-population} displays the population of each state as compiled from the 1870 US census [@walker2013statistical]. 
