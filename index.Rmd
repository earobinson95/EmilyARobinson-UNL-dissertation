...
```{r statistical-atlas-state-population, fig.cap = "Statistical Atlas 1870 state population", out.width="100%"}
...
```{r ATandT-revenue, fig.cap = "AT\\&T utilization of assets", out.width="100%"}
...
## Graphical Experiments {#lit-graphical-experiments}
