...
\rh{the grammar of graphics should be explained more.}
...
The knowledge a viewer brings to the situation influences their cognitive evaluation of the stimuli. \svp{Citation? You should probably also provide a bit more context for this piece of the paragraph instead of ending with dropping this one fact...} \rh{Agreed.}

The relationship between physiology and perception can provide us information about how graphics may be understood and interpreted. \rh{How?}
...
While a typical psychophysics experiment focuses on whether an effect is detectable and whether the magnitude of the effect can be accurately estimated, these early experiments instead depended on speed and accuracy for plot evaluation [@spence_visual_1990; @teghtsoonian1965judgment; @lewandowsky_perception_1989]. \rh{Examples?}

Cognitive psychologists and statisticians made progress by conducting experiments to identify perceptual errors \rh{Examples?} associated with different styles of graphics and charts [@spence_visual_1990; @cleveland_graphical_1985].
...
The last step involves translating the quantitative measures and relationships to the variables defined in the data set, such as a population decreasing over years. \rh{Are we talking about a specific example?}
...
\rh{I am a little confused with this paragraph...what are we talking about? And why here?}
...
At the beginning of 2020, we saw an influx of dashboards being developed to display case counts, transmission rates, and outbreak regions [@gmbh_youve_2020]; mass media routinely showed charts to share information with the public about the progression of the pandemic [@romano_scale_2020]. 
